...
STATIC_PAGES = [{'slug': 'about',
 ...
 {'slug': 'contact',
  ...
  'meta_description': 'Contact Open Source Signal with corrections, public-interest tips, OSINT '
                      'tools, source suggestions, and editorial inquiries.',
  ...
  'sections': [{'heading': 'English',
                'blocks': [{'type': 'p',
                            'text': 'Editorial contact: editor@osintsignal.org — corrections, '
                                    'editorial questions, attribution issues, and general '
                                    'inquiries.'},
                           {'type': 'p',
                            'text': 'Tips: tips@osintsignal.org — public-interest leads, cases, '
                                    'datasets, investigations, and materials that may deserve '
                                    'review.'},
                           {'type': 'p',
                            'text': 'Tools and workflows: tools@osintsignal.org — OSINT tools, '
                                    'GitHub repositories, documentation, verification utilities, '
                                    'maps, archives, and datasets.'},
                           {'type': 'p',
                            'text': 'Sources: sources@osintsignal.org — newsletters, research '
                                    'groups, Ukrainian OSINT projects, archives, Telegram channels '
                                    'for monitoring, community resources, and source suggestions.'},
                           {'type': 'p',
                            'text': 'Please do not send private addresses, phone numbers, family '
                                    ...
                                    'source context.'},
                           {'type': 'p',
                            'text': 'For sensitive tips, describe the public-interest value and '
                                    'the source context. If a claim is unverified, say so '
                                    'clearly.'}]},
               {'heading': 'Українською',
                'blocks': [{'type': 'p',
                            'text': 'Редакційний контакт: editor@osintsignal.org — виправлення, '
                                    'редакційні питання, атрибуція та загальні звернення.'},
                           {'type': 'p',
                            'text': 'Tips: tips@osintsignal.org — суспільно важливі підказки, '
                                    'кейси, датасети, розслідування й матеріали, які варто '
                                    'переглянути.'},
                           {'type': 'p',
                            'text': 'Інструменти та workflow: tools@osintsignal.org — '
                                    'OSINT-інструменти, GitHub-репозиторії, документація, утиліти '
                                    'верифікації, карти, архіви й набори даних.'},
                           {'type': 'p',
                            'text': 'Джерела: sources@osintsignal.org — розсилки, дослідницькі '
                                    'групи, українські OSINT-проєкти, архіви, Telegram-канали для '
                                    'моніторингу, спільноти й пропозиції щодо джерел.'},
                           {'type': 'p',
                            'text': 'Не надсилайте приватні адреси, телефони, сімейні дані, '
                                    'викрадені облікові дані, непублічні персональні бази, '
                                    'malware, exploit-матеріали, live targeting information або '
                                    'твердження про конкретних людей без контексту джерела.'},
                           {'type': 'p',
                            'text': 'Якщо tip чутливий, коротко поясніть суспільний інтерес і '
                                    'контекст джерела. Якщо твердження не перевірене — позначте це '
                                    'прямо.'}]}],
  'cta_links': [{'label': 'Methodology', 'href': 'methodology.html'},
                {'label': 'Ethics', 'href': 'ethics.html'},
                {'label': 'Subscribe', 'href': 'subscribe.html'}]},
 {'slug': 'subscribe',
  ...
  'sections': [{'heading': 'English',
                'blocks': [{'type': 'p',
                            'text': 'Telegram: follow new Daily Signal announcements at '
                                    'https://t.me/open_source_signal_ua.'},
                           {'type': 'p',
                            'text': 'RSS: use https://osintsignal.org/feed.xml in any feed '
                                    'reader.'},
                           {'type': 'p',
                            'text': 'Archive: browse previous issues at '
                                    'https://osintsignal.org/archive.html.'},
                           {'type': 'p',
                            'text': 'Daily Signal is published Monday to Friday when there is '
                                    'enough material worth surfacing. It focuses on OSINT '
                                    'investigations, Ukrainian accountability work, tools, '
                                    'datasets, verification methods, platform changes, OPSEC, and '
                                    'source-risk notes.'},
                           {'type': 'p',
                            'text': 'A future Weekly Magazine will collect and develop the '
                                    'strongest signals of the week into a more editorial '
                                    'format.'}]},
               {'heading': 'Українською',
                'blocks': [{'type': 'p',
                            'text': 'Telegram: повідомлення про нові випуски — '
                                    'https://t.me/open_source_signal_ua.'},
                           {'type': 'p',
                            'text': 'RSS: стрічка для feed reader — '
                                    'https://osintsignal.org/feed.xml.'},
                           {'type': 'p',
                            'text': 'Архів: попередні випуски — '
                                    'https://osintsignal.org/archive.html.'},
                           {'type': 'p',
                            'text': 'Daily Signal виходить з понеділка по п’ятницю, якщо є '
                                    'достатньо сильних матеріалів. Фокус — OSINT-розслідування, '
                                    'українська accountability-оптика, інструменти, датасети, '
                                    'методики верифікації, зміни платформ, OPSEC і ризики '
                                    'джерел.'}]}],
