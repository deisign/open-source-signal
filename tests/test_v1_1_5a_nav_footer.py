...
def test_homepage_exposes_trust_pages_above_the_fold(tmp_path):
    ...
    assert links == {"About": "about.html", "Methodology": "methodology.html", "Ethics": "ethics.html", "Contact": "contact.html", "Subscribe": "subscribe.html"}
...
def test_static_pages_keep_centered_footer_links(tmp_path):
    out_dir = tmp_path / "dist"
    build_site_into(out_dir)
    for name in ["about.html", "methodology.html", "ethics.html", "contact.html", "subscribe.html", "404.html"]:
